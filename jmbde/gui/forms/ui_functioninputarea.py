...
class Ui_FunctionInputArea(object):
    ...
    def retranslateUi(self, FunctionInputArea):
        FunctionInputArea.setWindowTitle(
            QCoreApplication.translate("FunctionInputArea", u"Funktion", None)
        )
        ...
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "FunctionInputArea", u"Letzte \u00c4nderung", None
            )
        )
        ...
        self.priorityLabel.setText(
            QCoreApplication.translate("FunctionInputArea", u"Priorit\u00e4t", None)
        )
        self.addPushButton.setText(
            QCoreApplication.translate("FunctionInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("FunctionInputArea", u"Bearbeiten", None)
        )
