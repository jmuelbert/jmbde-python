...
class Ui_MobileInputArea(object):
    ...
    def retranslateUi(self, MobileInputArea):
        MobileInputArea.setWindowTitle(
            QCoreApplication.translate("MobileInputArea", u"Mobil Telefon", None)
        )
        ...
        self.departmentLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Abteilung", None)
        )
        self.placeLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Platz", None)
        )
        self.pinLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Pin", None)
        )
        self.numberLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Nummer", None)
        )
        self.employeeLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Mitarbeiter*in", None)
        )
        self.manufacturerLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Hersteller", None)
        )
        self.serialNumberLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Seriennummer", None)
        )
        self.deviceTypeLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Ger\u00e4tetyp", None)
        )
        self.cardNumberLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Karten Nummer", None)
        )
        self.deviceNameLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Ger\u00e4tename", None)
        )
        self.replaceCheckBox.setText(
            QCoreApplication.translate("MobileInputArea", u"ersetzen", None)
        )
        self.inventoryLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Inventar", None)
        )
        self.activeCheckBox.setText(
            QCoreApplication.translate("MobileInputArea", u"Aktiv", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate("MobileInputArea", u"Letzte \u00c4nderung", None)
        )
        self.addPushButton.setText(
            QCoreApplication.translate("MobileInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("MobileInputArea", u"Bearbeiten", None)
        )
