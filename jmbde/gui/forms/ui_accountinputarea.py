...
class Ui_AccountInputArea(object):
    ...
    def retranslateUi(self, AccountInputArea):
        AccountInputArea.setWindowTitle(
            QCoreApplication.translate("AccountInputArea", u"Employee", None)
        )
        # if QT_CONFIG(accessibility)
        AccountInputArea.setAccessibleName(
            QCoreApplication.translate("AccountInputArea", u"AccountInputDialog", None)
        )
        # endif // QT_CONFIG(accessibility)
        AccountInputArea.setTitle(
            QCoreApplication.translate("AccountInputArea", u"Zugang", None)
        )
        self.label_Header.setText(
            QCoreApplication.translate("AccountInputArea", u"Zug\u00e4nge", None)
        )
        self.systemLabel.setText(
            QCoreApplication.translate("AccountInputArea", u"System", None)
        )
        self.userNameLabel.setText(
            QCoreApplication.translate("AccountInputArea", u"Anmeldename", None)
        )
        self.passwordLabel.setText(
            QCoreApplication.translate("AccountInputArea", u"Passwort", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "AccountInputArea", u"Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("AccountInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("AccountInputArea", u"Bearbeiten", None)
        )
