...
class Ui_ChipCardProfileDoorInputArea(object):
    ...
    def retranslateUi(self, ChipCardProfileDoorInputArea):
        ...
        ChipCardProfileDoorInputArea.setAccessibleName(
            QCoreApplication.translate(
                "ChipCardProfileDoorInputArea", u"ChipCardProfileInputDialog", None
            )
        )
        ...
        self.profileDoorLabel.setText(
            QCoreApplication.translate(
                "ChipCardProfileDoorInputArea", u"Profil T\u00fcr", None
            )
        )
        self.profileLabel.setText(
            QCoreApplication.translate("ChipCardProfileDoorInputArea", u"Profil", None)
        )
        self.doorLabel.setText(
            QCoreApplication.translate(
                "ChipCardProfileDoorInputArea", u"T\u00fcr", None
            )
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "ChipCardProfileDoorInputArea", u"Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("ChipCardProfileDoorInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate(
                "ChipCardProfileDoorInputArea", u"Bearbeiten", None
            )
        )
