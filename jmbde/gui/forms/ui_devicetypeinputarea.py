...
class Ui_DeviceTypeInputArea(object):
    ...
    def retranslateUi(self, DeviceTypeInputArea):
        DeviceTypeInputArea.setWindowTitle(
            QCoreApplication.translate("DeviceTypeInputArea", u"Ger\u00e4te Typ", None)
        )
        # if QT_CONFIG(accessibility)
        DeviceTypeInputArea.setAccessibleName(
            QCoreApplication.translate(
                "DeviceTypeInputArea", u"DeviceTypeInputDialog", None
            )
        )
        ...
        self.nameLabel.setText(
            QCoreApplication.translate("DeviceTypeInputArea", u"Typ", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "DeviceTypeInputArea", u"Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("DeviceTypeInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("DeviceTypeInputArea", u"Bearbeiten", None)
        )
