...
class Ui_CityInputArea(object):
    ...
    def retranslateUi(self, CityInputArea):
        CityInputArea.setWindowTitle(
            QCoreApplication.translate("CityInputArea", u"Ort", None)
        )
        ...
        self.cityNameLabel.setText(
            QCoreApplication.translate("CityInputArea", u"Ort/Name", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate("CityInputArea", u"Letzte \u00c4nderung", None)
        )
        self.addPushButton.setText(
            QCoreApplication.translate("CityInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("CityInputArea", u"Bearbeiten", None)
        )
