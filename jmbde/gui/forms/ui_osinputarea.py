...
class Ui_OSInputArea(object):
    ...
    def retranslateUi(self, OSInputArea):
        OSInputArea.setWindowTitle(
            QCoreApplication.translate("OSInputArea", u"Betriebssystem", None)
        )
        ...
        self.lastUpdateLabel.setText(
            QCoreApplication.translate("OSInputArea", u"Letzte \u00c4nderung", None)
        )
        self.addPushButton.setText(
            QCoreApplication.translate("OSInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("OSInputArea", u"Bearbeiten", None)
        )
