...
class Ui_ProcessorInputArea(object):
    ...
    def retranslateUi(self, ProcessorInputArea):
        ProcessorInputArea.setWindowTitle(
            QCoreApplication.translate("ProcessorInputArea", u"Prozessor", None)
        )
        # if QT_CONFIG(accessibility)
        ProcessorInputArea.setAccessibleName(
            QCoreApplication.translate(
                "ProcessorInputArea", u"ProcessorInputDialog", None
            )
        )
        ...
        self.clockRateLabel.setText(
            QCoreApplication.translate("ProcessorInputArea", u"Taktrate", None)
        )
        self.nameLabel.setText(
            QCoreApplication.translate("ProcessorInputArea", u"Name", None)
        )
        self.clockRateLabel_2.setText(
            QCoreApplication.translate("ProcessorInputArea", u"Ghz", None)
        )
        self.coresLabel.setText(
            QCoreApplication.translate("ProcessorInputArea", u"Kerne", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "ProcessorInputArea", u"Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("ProcessorInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("ProcessorInputArea", u"Bearbeiten", None)
        )
