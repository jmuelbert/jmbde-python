...
class Ui_ZipCodeInputArea(object):
    ...
    def retranslateUi(self, ZipCodeInputArea):
        ZipCodeInputArea.setWindowTitle(
            QCoreApplication.translate("ZipCodeInputArea", u"PLZ", None)
        )
        # if QT_CONFIG(accessibility)
        ZipCodeInputArea.setAccessibleName(
            QCoreApplication.translate("ZipCodeInputArea", u"ChipCardInputDialog", None)
        )
        ...
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "ZipCodeInputArea", u"Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("ZipCodeInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("ZipCodeInputArea", u"Bearbeiten", None)
        )
