    ...
    def retranslateUi(self, ChipCardDoorInputArea):
        ChipCardDoorInputArea.setWindowTitle(
            QCoreApplication.translate(
                "ChipCardDoorInputArea", u"Schl\u00fcsselchip T\u00fcr", None
            )
        )
        # if QT_CONFIG(accessibility)
        ChipCardDoorInputArea.setAccessibleName(
            QCoreApplication.translate(
                "ChipCardDoorInputArea", u"ChipCardDoorInputDialog", None
            )
        )
        ...
        self.placeLabel.setText(
            QCoreApplication.translate("ChipCardDoorInputArea", u"Ort", None)
        )
        self.departmentLabel.setText(
            QCoreApplication.translate("ChipCardDoorInputArea", u"Abteilung", None)
        )
        self.numberLabel.setText(
            QCoreApplication.translate("ChipCardDoorInputArea", u"Nummer", None)
        )
        self.employeeLabel.setText(
            QCoreApplication.translate("ChipCardDoorInputArea", u"Mitarbeiter*in", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "ChipCardDoorInputArea", u"Letze \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("ChipCardDoorInputArea", u"+", None)
        )
        # if QT_CONFIG(accessibility)
        self.editFinishPushButton.setAccessibleName(
            QCoreApplication.translate(
                "ChipCardDoorInputArea", u"ChipCardDoorDialog", None
            )
        )
        # endif // QT_CONFIG(accessibility)
        self.editFinishPushButton.setText(
            QCoreApplication.translate("ChipCardDoorInputArea", u"Bearbeiten", None)
        )
