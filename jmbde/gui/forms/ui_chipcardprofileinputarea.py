...
class Ui_ChipCardProfileInputArea(object):
    ...
    def retranslateUi(self, ChipCardProfileInputArea):
        ChipCardProfileInputArea.setWindowTitle(
            QCoreApplication.translate(
                "ChipCardProfileInputArea", u"Schl\u00fcsselchip Profil", None
            )
        )
        # if QT_CONFIG(accessibility)
        ChipCardProfileInputArea.setAccessibleName(
            QCoreApplication.translate(
                "ChipCardProfileInputArea", u"ChipCardProfileInputDialog", None
            )
        )
        # endif // QT_CONFIG(accessibility)
        ChipCardProfileInputArea.setTitle(
            QCoreApplication.translate(
                "ChipCardProfileInputArea", u"Schl\u00fcsselchip Profil", None
            )
        )
        ...
        self.numberLabel.setText(
            QCoreApplication.translate("ChipCardProfileInputArea", u"Nummer", None)
        )
        self.doorLabel.setText(
            QCoreApplication.translate("ChipCardProfileInputArea", u"T\u00fcr", None)
        )
        self.employeeLabel.setText(
            QCoreApplication.translate(
                "ChipCardProfileInputArea", u"Mitarbeiter*in", None
            )
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "ChipCardProfileInputArea", u"Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("ChipCardProfileInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("ChipCardProfileInputArea", u"Bearbeiten", None)
        )
