...
class Ui_DepartmentInputArea(object):
    ...
    def retranslateUi(self, DepartmentInputArea):
        DepartmentInputArea.setWindowTitle(
            QCoreApplication.translate("DepartmentInputArea", u"Abteilung", None)
        )
        ...
        self.priorityLabel.setText(
            QCoreApplication.translate("DepartmentInputArea", u"Priorit\u00e4t", None)
        )
        self.printerLabel.setText(
            QCoreApplication.translate("DepartmentInputArea", u"Drucker", None)
        )
        ...
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "DepartmentInputArea", u"Letzte \u00c4nderung", None
            )
        )
        ...
        self.editFinishPushButton.setText(
            QCoreApplication.translate("DepartmentInputArea", u"Bearbeiten", None)
        )
