    ...
    def retranslateUi(self, EmployeeAccountInputArea):
        EmployeeAccountInputArea.setWindowTitle(
            QCoreApplication.translate(
                "EmployeeAccountInputArea", u"Mitarbeiter*in Zugang", None
            )
        )
        # if QT_CONFIG(accessibility)
        EmployeeAccountInputArea.setAccessibleName(
            QCoreApplication.translate(
                "EmployeeAccountInputArea", u"EmployeeAccountInputDialog", None
            )
        )
        ...
        self.employeeIdLabel.setText(
            QCoreApplication.translate(
                "EmployeeAccountInputArea", u"Mitarbeiter*in", None
            )
        )
        self.accountLabel.setText(
            QCoreApplication.translate("EmployeeAccountInputArea", u"Zugang", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "EmployeeAccountInputArea", u"Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("EmployeeAccountInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("EmployeeAccountInputArea", u"Bearbeiten", None)
        )
