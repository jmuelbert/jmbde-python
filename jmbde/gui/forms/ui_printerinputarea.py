...
class Ui_PrinterInputArea(object):
    ...
    def retranslateUi(self, PrinterInputArea):
        PrinterInputArea.setWindowTitle(
            QCoreApplication.translate("PrinterInputArea", u"Drucker", None)
        )
        ...
        self.activeCheckBox.setText(
            QCoreApplication.translate("PrinterInputArea", u"Aktiv", None)
        )
        self.manufacturerLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Hersteller", None)
        )
        self.computerLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Computer", None)
        )
        self.resourcesLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Verbrauchsmaterial", None)
        )
        self.replaceCheckBox.setText(
            QCoreApplication.translate("PrinterInputArea", u"ersetzen", None)
        )
        self.colorCheckBox.setText(
            QCoreApplication.translate("PrinterInputArea", u"Farbe", None)
        )
        self.networkLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Netzwerk", None)
        )
        self.departmentLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Abteilung", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Lezte \u00c4nderung", None)
        )
        self.deviceNameLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Ger\u00e4tename", None)
        )
        self.inventoryLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Inventar", None)
        )
        self.employeeLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Mitarbeiter*in", None)
        )
        self.paperSizeLabel.setText(
            QCoreApplication.translate(
                "PrinterInputArea", u"Papiergr\u00f6\u00dfe", None
            )
        )
        self.placeLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Platz", None)
        )
        self.serialNumberLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Seriennummer", None)
        )
        self.deviceTypeLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Ger\u00e4tetyp", None)
        )
        self.networkNameLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"Netzwerk Name", None)
        )
        self.ipAddressLabel.setText(
            QCoreApplication.translate("PrinterInputArea", u"IP Adresse", None)
        )
        self.addPushButton.setText(
            QCoreApplication.translate("PrinterInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("PrinterInputArea", u"Bearbeiten", None)
        )
