...
class Ui_PlaceInputArea(object):
    ...
    def retranslateUi(self, PlaceInputArea):
        PlaceInputArea.setWindowTitle(
            QCoreApplication.translate("PlaceInputArea", u"Platz", None)
        )
        # if QT_CONFIG(accessibility)
        PlaceInputArea.setAccessibleName(
            QCoreApplication.translate("PlaceInputArea", u"PlaceInputDialog", None)
        )
        ...
        self.nameLabel.setText(
            QCoreApplication.translate("PlaceInputArea", u"Name", None)
        )
        self.roomLabel.setText(
            QCoreApplication.translate("PlaceInputArea", u"Raum", None)
        )
        self.deskLabel.setText(
            QCoreApplication.translate("PlaceInputArea", u"Tisch", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate("PlaceInputArea", u"Letzte \u00c4nderung", None)
        )
        self.addPushButton.setText(
            QCoreApplication.translate("PlaceInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("PlaceInputArea", u"Bearbeiten", None)
        )
