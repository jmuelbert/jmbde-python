...
class Ui_ManufacturerInputArea(object):
    ...
    def retranslateUi(self, ManufacturerInputArea):
        ManufacturerInputArea.setWindowTitle(
            QCoreApplication.translate("ManufacturerInputArea", u"Hersteller", None)
        )
        ...
        self.zipCodeLabel.setText(
            QCoreApplication.translate("ManufacturerInputArea", u"PLZ", None)
        )
        self.hotlineNumberLabel.setText(
            QCoreApplication.translate("ManufacturerInputArea", u"Hotline", None)
        )
        self.nameLabel.setText(
            QCoreApplication.translate("ManufacturerInputArea", u"Name", None)
        )
        self.mailAddressLabel.setText(
            QCoreApplication.translate("ManufacturerInputArea", u"Mail", None)
        )
        self.faxNumberLabel.setText(
            QCoreApplication.translate("ManufacturerInputArea", u"Fax", None)
        )
        self.cityLabel.setText(
            QCoreApplication.translate("ManufacturerInputArea", u"Ort", None)
        )
        ...
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "ManufacturerInputArea", u"Letzte \u00c4nderung", None
            )
        )
        ...
        self.addressLabel.setText(
            QCoreApplication.translate("ManufacturerInputArea", u"Stra\u00dfe", None)
        )
        self.phoneNumberLabel.setText(
            QCoreApplication.translate("ManufacturerInputArea", u"Telefon", None)
        )
        self.address2Label.setText(
            QCoreApplication.translate("ManufacturerInputArea", u"Stra\u00dfe 2", None)
        )
        self.addPushButton.setText(
            QCoreApplication.translate("ManufacturerInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("ManufacturerInputArea", u"Bearbeiten", None)
        )
