    ...
    def retranslateUi(self, EmployeeDocumentInputArea):
        EmployeeDocumentInputArea.setWindowTitle(
            QCoreApplication.translate(
                "EmployeeDocumentInputArea", u"Mitarbeiter*in Dokument", None
            )
        )
        # if QT_CONFIG(accessibility)
        EmployeeDocumentInputArea.setAccessibleName(
            QCoreApplication.translate(
                "EmployeeDocumentInputArea", u"EmployeeDocumentInputDialog", None
            )
        )
        ...
        self.employeeIdLabel.setText(
            QCoreApplication.translate(
                "EmployeeDocumentInputArea", u"Mitarbeiter*in", None
            )
        )
        self.documentIdLabel.setText(
            QCoreApplication.translate("EmployeeDocumentInputArea", u"Dokument", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "EmployeeDocumentInputArea", u"Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("EmployeeDocumentInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("EmployeeDocumentInputArea", u"Bearbeiten", None)
        )
