...
class Ui_ZipCityInputArea(object):
    ...
    def retranslateUi(self, ZipCityInputArea):
        ZipCityInputArea.setWindowTitle(
            QCoreApplication.translate("ZipCityInputArea", u"PLZ Ort", None)
        )
        # if QT_CONFIG(accessibility)
        ZipCityInputArea.setAccessibleName(
            QCoreApplication.translate("ZipCityInputArea", u"ZipCityInputDialog", None)
        )
        ...
        self.zipCodeLabel.setText(
            QCoreApplication.translate("ZipCityInputArea", u"PLZ", None)
        )
        self.cityLabel.setText(
            QCoreApplication.translate("ZipCityInputArea", u"Ort", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "ZipCityInputArea", u"Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("ZipCityInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("ZipCityInputArea", u"Bearbeiten", None)
        )
