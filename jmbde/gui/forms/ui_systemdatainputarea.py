...
class Ui_SystemDataInputArea(object):
    ...
    def retranslateUi(self, SystemDataInputArea):
        SystemDataInputArea.setWindowTitle(
            QCoreApplication.translate("SystemDataInputArea", u"System Daten", None)
        )
        # if QT_CONFIG(accessibility)
        SystemDataInputArea.setAccessibleName(
            QCoreApplication.translate(
                "SystemDataInputArea", u"SystemDataInputDialog", None
            )
        )
        ...
        self.nameLabel.setText(
            QCoreApplication.translate("SystemDataInputArea", u"Name", None)
        )
        self.localCheckBox.setText(
            QCoreApplication.translate("SystemDataInputArea", u"Lokal", None)
        )
        self.companyLabel.setText(
            QCoreApplication.translate("SystemDataInputArea", u"Firma", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "SystemDataInputArea", u"Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("SystemDataInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("SystemDataInputArea", u"Bearbeiten", None)
        )
