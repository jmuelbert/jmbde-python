...
class Ui_PhoneInputArea(object):
    ...
    def retranslateUi(self, PhoneInputArea):
        PhoneInputArea.setWindowTitle(
            QCoreApplication.translate("PhoneInputArea", u"Telefon", None)
        )
        ...
        self.deviceNameLabel.setText(
            QCoreApplication.translate("PhoneInputArea", u"Ger\u00e4tename", None)
        )
        self.placeLabel.setText(
            QCoreApplication.translate("PhoneInputArea", u"Platz", None)
        )
        self.pinLabel.setText(
            QCoreApplication.translate("PhoneInputArea", u"Pin", None)
        )
        self.manufacturerLabel.setText(
            QCoreApplication.translate("PhoneInputArea", u"Hersteller", None)
        )
        self.numberLabel.setText(
            QCoreApplication.translate("PhoneInputArea", u"Nummer", None)
        )
        self.inventoryLabel.setText(
            QCoreApplication.translate("PhoneInputArea", u"Inventar", None)
        )
        self.deviceTypeLabel.setText(
            QCoreApplication.translate("PhoneInputArea", u"Ger\u00e4tetyp", None)
        )
        self.employeeLabel.setText(
            QCoreApplication.translate("PhoneInputArea", u"Mitarbeiter*in", None)
        )
        self.serialNumberLabel.setText(
            QCoreApplication.translate("PhoneInputArea", u"Seriennummer", None)
        )
        self.activeCheckBox.setText(
            QCoreApplication.translate("PhoneInputArea", u"Aktiv", None)
        )
        self.departmentLabel.setText(
            QCoreApplication.translate("PhoneInputArea", u"Abteilung", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate("PhoneInputArea", u"Letzte \u00c4nderuung", None)
        )
        self.replaceCheckBox.setText(
            QCoreApplication.translate("PhoneInputArea", u"ersetzen", None)
        )
        self.addPushButton.setText(
            QCoreApplication.translate("PhoneInputArea", u"+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("PhoneInputArea", u"Bearbeiten", None)
        )
