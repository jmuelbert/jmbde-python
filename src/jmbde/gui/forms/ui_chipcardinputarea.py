...
class Ui_ChipCardInputArea(object):
    ...
    def retranslateUi(self, ChipCardInputArea):
        ChipCardInputArea.setWindowTitle(QCoreApplication.translate("ChipCardInputArea", u"Schl\u00fcsselchip", None))
#if QT_CONFIG(accessibility)
        ChipCardInputArea.setAccessibleName(QCoreApplication.translate("ChipCardInputArea", u"ChipCardInputDialog", None))
#endif // QT_CONFIG(accessibility)
        ChipCardInputArea.setTitle(QCoreApplication.translate("ChipCardInputArea", u"Schl\u00fcsselchip", None))
        self.label_Header.setText(QCoreApplication.translate("ChipCardInputArea", u"Schl\u00fcsselchip", None))
        self.numberLabel.setText(QCoreApplication.translate("ChipCardInputArea", u"Nummer", None))
        self.doorLabel.setText(QCoreApplication.translate("ChipCardInputArea", u"T\u00fcr", None))
        self.profileLabel.setText(QCoreApplication.translate("ChipCardInputArea", u"Profil", None))
        self.employeeLabel.setText(QCoreApplication.translate("ChipCardInputArea", u"Mitarbeiter*in", None))
        self.lastUpdateLabel.setText(QCoreApplication.translate("ChipCardInputArea", u"Letzte \u00c4nderung", None))
        self.addPushButton.setText(QCoreApplication.translate("ChipCardInputArea", u"+", None))
        self.editFinishPushButton.setText(QCoreApplication.translate("ChipCardInputArea", u"Bearbeiten", None))
    # retranslateUi
