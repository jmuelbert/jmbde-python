...
class Ui_ComputerInputArea(object):
    ...
    def retranslateUi(self, ComputerInputArea):
        ComputerInputArea.setWindowTitle(QCoreApplication.translate("ComputerInputArea", u"GroupBox", None))
#if QT_CONFIG(accessibility)
        ComputerInputArea.setAccessibleName(QCoreApplication.translate("ComputerInputArea", u"ComputerInputDialog", None))
#endif // QT_CONFIG(accessibility)
        ComputerInputArea.setTitle(QCoreApplication.translate("ComputerInputArea", u"Computer", None))
        self.label_Header.setText(QCoreApplication.translate("ComputerInputArea", u"Computer", None))
        self.serialNumberLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Serial Number", None))
        self.printerLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Drucker", None))
        self.deviceTypeLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Ger\u00e4tetyp", None))
        self.networkLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Netzwerk", None))
        self.inventoryLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Inventarnummer", None))
        self.placeLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Platz", None))
        self.lastUpdateLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Letzte \u00c4nderung", None))
        self.processorLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Prozessor", None))
        self.serviceNumberLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Service Nummer", None))
        self.serviceTagLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Service Tag", None))
        self.manufacturerLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Hersteller", None))
        self.activeCheckBox.setText(QCoreApplication.translate("ComputerInputArea", u"Aktiv", None))
        self.deviceNameLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Ger\u00e4tename", None))
        self.replaceCheckBox.setText(QCoreApplication.translate("ComputerInputArea", u"zu ersetzen", None))
        self.departmentLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Abteilung", None))
        self.memoryLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Speicher", None))
        self.netWorkNameLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Name", None))
        self.ipAddressLabel.setText(QCoreApplication.translate("ComputerInputArea", u"IP Addresse", None))
        self.operationSystemLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Betriebssystem", None))
        self.softwareLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Software", None))
        self.employeeLabel.setText(QCoreApplication.translate("ComputerInputArea", u"Mitarbeiter*in", None))
        self.addPushButton.setText(QCoreApplication.translate("ComputerInputArea", u"+", None))
        self.editFinishPushButton.setText(QCoreApplication.translate("ComputerInputArea", u"Bearbeiten", None))
    # retranslateUi
