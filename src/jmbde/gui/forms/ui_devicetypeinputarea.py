...
class Ui_DeviceTypeInputArea:
    def setupUi(self, DeviceTypeInputArea):
        if not DeviceTypeInputArea.objectName():
            DeviceTypeInputArea.setObjectName("DeviceTypeInputArea")
    ...
    def retranslateUi(self, DeviceTypeInputArea):
        DeviceTypeInputArea.setWindowTitle(
            QCoreApplication.translate("DeviceTypeInputArea", "Ger\u00e4te Typ", None)
        )
        # if QT_CONFIG(accessibility)
        DeviceTypeInputArea.setAccessibleName(
            QCoreApplication.translate(
                "DeviceTypeInputArea", "DeviceTypeInputDialog", None
            )
        )
        # endif // QT_CONFIG(accessibility)
        DeviceTypeInputArea.setTitle(
            QCoreApplication.translate("DeviceTypeInputArea", "Ger\u00e4te Typ", None)
        )
        ...
        self.nameLabel.setText(
            QCoreApplication.translate("DeviceTypeInputArea", "Typ", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "DeviceTypeInputArea", "Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("DeviceTypeInputArea", "+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("DeviceTypeInputArea", "Bearbeiten", None)
        )
