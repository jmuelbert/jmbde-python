...
class Ui_ChipCardProfileInputArea(object):
    def setupUi(self, ChipCardProfileInputArea):
        if not ChipCardProfileInputArea.objectName():
            ChipCardProfileInputArea.setObjectName("ChipCardProfileInputArea")
    ...
    def retranslateUi(self, ChipCardProfileInputArea):
        ChipCardProfileInputArea.setWindowTitle(
            QCoreApplication.translate(
                "ChipCardProfileInputArea", "Schl\u00fcsselchip Profil", None
            )
        )
        # if QT_CONFIG(accessibility)
        ChipCardProfileInputArea.setAccessibleName(
            QCoreApplication.translate(
                "ChipCardProfileInputArea", "ChipCardProfileInputDialog", None
            )
        )
        ...
        self.numberLabel.setText(
            QCoreApplication.translate("ChipCardProfileInputArea", "Nummer", None)
        )
        self.doorLabel.setText(
            QCoreApplication.translate("ChipCardProfileInputArea", "T\u00fcr", None)
        )
        self.employeeLabel.setText(
            QCoreApplication.translate(
                "ChipCardProfileInputArea", "Mitarbeiter*in", None
            )
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate(
                "ChipCardProfileInputArea", "Letzte \u00c4nderung", None
            )
        )
        self.addPushButton.setText(
            QCoreApplication.translate("ChipCardProfileInputArea", "+", None)
        )
        self.editFinishPushButton.setText(
            QCoreApplication.translate("ChipCardProfileInputArea", "Bearbeiten", None)
        )
