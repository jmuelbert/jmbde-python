...
################################################################################
## Form generated from reading UI file 'chipcardprofileinputarea.ui'
##
...
class Ui_ChipCardProfileInputArea(object):
    def setupUi(self, ChipCardProfileInputArea):
        if not ChipCardProfileInputArea.objectName():
            ChipCardProfileInputArea.setObjectName(u"ChipCardProfileInputArea")
        ChipCardProfileInputArea.resize(730, 600)
        self.gridLayout_3 = QGridLayout(ChipCardProfileInputArea)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.GroupBox = QWidget(ChipCardProfileInputArea)
        ...
        self.formLayout.setWidget(2, QFormLayout.LabelRole, self.employeeLabel)
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.employeeComboBox)
        ...
        QWidget.setTabOrder(self.doorComboBox, self.employeeComboBox)
        ...
        self.retranslateUi(ChipCardProfileInputArea)

        QMetaObject.connectSlotsByName(ChipCardProfileInputArea)
    # setupUi

    def retranslateUi(self, ChipCardProfileInputArea):
        ChipCardProfileInputArea.setWindowTitle(QCoreApplication.translate("ChipCardProfileInputArea", u"Schl\u00fcsselchip Profil", None))
#if QT_CONFIG(accessibility)
        ChipCardProfileInputArea.setAccessibleName(QCoreApplication.translate("ChipCardProfileInputArea", u"ChipCardProfileInputDialog", None))
#endif // QT_CONFIG(accessibility)
        ChipCardProfileInputArea.setTitle(QCoreApplication.translate("ChipCardProfileInputArea", u"Schl\u00fcsselchip Profil", None))
        self.label_Header.setText(QCoreApplication.translate("ChipCardProfileInputArea", u"Schl\u00fcsselchip Profil", None))
        self.numberLabel.setText(QCoreApplication.translate("ChipCardProfileInputArea", u"Nummer", None))
        self.doorLabel.setText(QCoreApplication.translate("ChipCardProfileInputArea", u"T\u00fcr", None))
        self.employeeLabel.setText(QCoreApplication.translate("ChipCardProfileInputArea", u"Mitarbeiter*in", None))
        self.lastUpdateLabel.setText(QCoreApplication.translate("ChipCardProfileInputArea", u"Letzte \u00c4nderung", None))
        self.addPushButton.setText(QCoreApplication.translate("ChipCardProfileInputArea", u"+", None))
        self.editFinishPushButton.setText(QCoreApplication.translate("ChipCardProfileInputArea", u"Bearbeiten", None))
    # retranslateUi
