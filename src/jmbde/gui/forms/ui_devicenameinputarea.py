...
class Ui_DeviceNameInputArea(object):
    ...
    def retranslateUi(self, DeviceNameInputArea):
        DeviceNameInputArea.setWindowTitle(QCoreApplication.translate("DeviceNameInputArea", u"Ger\u00e4te Name", None))
#if QT_CONFIG(accessibility)
        DeviceNameInputArea.setAccessibleName(QCoreApplication.translate("DeviceNameInputArea", u"DeviceNameInputDialog", None))
#endif // QT_CONFIG(accessibility)
        DeviceNameInputArea.setTitle(QCoreApplication.translate("DeviceNameInputArea", u"Ger\u00e4te Name", None))
        self.label_Header.setText(QCoreApplication.translate("DeviceNameInputArea", u"Ger\u00e4te Name", None))
        self.nameLabel.setText(QCoreApplication.translate("DeviceNameInputArea", u"Name", None))
        self.lastUpdateLabel.setText(QCoreApplication.translate("DeviceNameInputArea", u"Letzte \u00c4nderung", None))
        self.addPushButton.setText(QCoreApplication.translate("DeviceNameInputArea", u"+", None))
        self.editFinishPushButton.setText(QCoreApplication.translate("DeviceNameInputArea", u"Bearbeiten", None))
    # retranslateUi
