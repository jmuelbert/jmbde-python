...
class Ui_FaxInputArea(object):
    ...
    def retranslateUi(self, FaxInputArea):
        FaxInputArea.setWindowTitle(QCoreApplication.translate("FaxInputArea", u"Fax", None))
#if QT_CONFIG(accessibility)
        FaxInputArea.setAccessibleName(QCoreApplication.translate("FaxInputArea", u"FaxInputDialog", None))
#endif // QT_CONFIG(accessibility)
        FaxInputArea.setTitle(QCoreApplication.translate("FaxInputArea", u"Fax", None))
        self.label_Header.setText(QCoreApplication.translate("FaxInputArea", u"Fax", None))
        self.departmentLabel.setText(QCoreApplication.translate("FaxInputArea", u"Abteilung", None))
        self.inventoryLabel.setText(QCoreApplication.translate("FaxInputArea", u"Inventar Nummer", None))
        self.serialNumberLabel.setText(QCoreApplication.translate("FaxInputArea", u"Seriennummer", None))
        self.placeLabel.setText(QCoreApplication.translate("FaxInputArea", u"Platz", None))
        self.employeeLabel.setText(QCoreApplication.translate("FaxInputArea", u"Mitarbeiter*in", None))
        self.pinLabel.setText(QCoreApplication.translate("FaxInputArea", u"Pin", None))
        self.replaceCheckBox.setText(QCoreApplication.translate("FaxInputArea", u"ersetzen", None))
        self.deviceTypeLabel.setText(QCoreApplication.translate("FaxInputArea", u"Ger\u00e4tetyp", None))
        self.deviceNameLabel.setText(QCoreApplication.translate("FaxInputArea", u"Ger\u00e4tename", None))
        self.manufacturerLabel.setText(QCoreApplication.translate("FaxInputArea", u"Hersteller", None))
        self.activeCheckBox.setText(QCoreApplication.translate("FaxInputArea", u"Aktiv", None))
        self.numberLabel.setText(QCoreApplication.translate("FaxInputArea", u"Nummer", None))
        self.lastUpdateLabel.setText(QCoreApplication.translate("FaxInputArea", u"Letzte \u00c4nderung", None))
        self.addPushButton.setText(QCoreApplication.translate("FaxInputArea", u"+", None))
        self.editFinishPushButton.setText(QCoreApplication.translate("FaxInputArea", u"Bearbeiten", None))
    # retranslateUi
