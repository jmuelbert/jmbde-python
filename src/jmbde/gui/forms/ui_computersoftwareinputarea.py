...
class Ui_ComputerSoftwareInputArea(object):
    ...
    def retranslateUi(self, ComputerSoftwareInputArea):
        ComputerSoftwareInputArea.setWindowTitle(QCoreApplication.translate("ComputerSoftwareInputArea", u"Computer Software", None))
#if QT_CONFIG(accessibility)
        ComputerSoftwareInputArea.setAccessibleName(QCoreApplication.translate("ComputerSoftwareInputArea", u"ComputerSoftwareInputDialog", None))
#endif // QT_CONFIG(accessibility)
        ComputerSoftwareInputArea.setTitle(QCoreApplication.translate("ComputerSoftwareInputArea", u"Computer Software", None))
        self.label_Header.setText(QCoreApplication.translate("ComputerSoftwareInputArea", u"Computer Software", None))
        self.computerLabel.setText(QCoreApplication.translate("ComputerSoftwareInputArea", u"Computer", None))
        self.softwareLabel.setText(QCoreApplication.translate("ComputerSoftwareInputArea", u"Software", None))
        self.lastUpdateLabel.setText(QCoreApplication.translate("ComputerSoftwareInputArea", u"Letzte \u00c4nderung", None))
        self.addPushButton.setText(QCoreApplication.translate("ComputerSoftwareInputArea", u"+", None))
        self.editFinishPushButton.setText(QCoreApplication.translate("ComputerSoftwareInputArea", u"Bearbeiten", None))
    # retranslateUi
