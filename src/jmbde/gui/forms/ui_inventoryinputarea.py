...
class Ui_InventoryInputArea(object):
    ...
    def retranslateUi(self, InventoryInputArea):
        InventoryInputArea.setWindowTitle(QCoreApplication.translate("InventoryInputArea", u"Inventar", None))
#if QT_CONFIG(accessibility)
        InventoryInputArea.setAccessibleName(QCoreApplication.translate("InventoryInputArea", u"InventoryInputDialog", None))
#endif // QT_CONFIG(accessibility)
        InventoryInputArea.setTitle(QCoreApplication.translate("InventoryInputArea", u"Inventar", None))
        self.headerLabel.setText(QCoreApplication.translate("InventoryInputArea", u"Inventar", None))
        self.label_Number.setText(QCoreApplication.translate("InventoryInputArea", u"Nummer", None))
        self.descriptionLabel.setText(QCoreApplication.translate("InventoryInputArea", u"Text", None))
        self.lastUpdateLabel.setText(QCoreApplication.translate("InventoryInputArea", u"Letzte \u00c4nderung", None))
        self.activCheckBox.setText(QCoreApplication.translate("InventoryInputArea", u"Aktiv", None))
        self.addPushButton.setText(QCoreApplication.translate("InventoryInputArea", u"+", None))
        self.editFinishPushButton.setText(QCoreApplication.translate("InventoryInputArea", u"Bearbeiten", None))
    # retranslateUi
