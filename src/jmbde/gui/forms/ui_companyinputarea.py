...
class Ui_CompanyInputArea(object):
    ...
    def retranslateUi(self, CompanyInputArea):
        CompanyInputArea.setWindowTitle(QCoreApplication.translate("CompanyInputArea", u"Firma", None))
#if QT_CONFIG(accessibility)
        CompanyInputArea.setAccessibleName(QCoreApplication.translate("CompanyInputArea", u"CompanyInputDialog", None))
#endif // QT_CONFIG(accessibility)
        CompanyInputArea.setTitle(QCoreApplication.translate("CompanyInputArea", u"Firma", None))
        self.label_Header.setText(QCoreApplication.translate("CompanyInputArea", u"Firma", None))
        self.nameLabel.setText(QCoreApplication.translate("CompanyInputArea", u"Name", None))
        self.name2Label.setText(QCoreApplication.translate("CompanyInputArea", u"Name2", None))
        self.streetLabel.setText(QCoreApplication.translate("CompanyInputArea", u"Stra\u00dfe", None))
        self.zipCodeLabel.setText(QCoreApplication.translate("CompanyInputArea", u"PLZ", None))
        self.cityLabel.setText(QCoreApplication.translate("CompanyInputArea", u"Ort", None))
        self.phoneNumberLabel.setText(QCoreApplication.translate("CompanyInputArea", u"Telefon", None))
        self.mobileNumberLabel.setText(QCoreApplication.translate("CompanyInputArea", u"Mobil Nummer", None))
        self.faxNumberLabel.setText(QCoreApplication.translate("CompanyInputArea", u"Fax", None))
        self.mailAddressLabel.setText(QCoreApplication.translate("CompanyInputArea", u"E Mail", None))
        self.activeLabel.setText(QCoreApplication.translate("CompanyInputArea", u"Aktiv", None))
        self.employeeIdLabel.setText(QCoreApplication.translate("CompanyInputArea", u"Mitarbeiter*in", None))
        self.lastUpdateLabel.setText(QCoreApplication.translate("CompanyInputArea", u"Letzte \u00c4nderung", None))
        self.addPushButton.setText(QCoreApplication.translate("CompanyInputArea", u"+", None))
        self.editFinishPushButton.setText(QCoreApplication.translate("CompanyInputArea", u"Bearbeiten", None))
    # retranslateUi
