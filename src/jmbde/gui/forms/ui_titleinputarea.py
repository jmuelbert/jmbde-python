...
class Ui_TitleInputArea(object):
    ...
    def retranslateUi(self, TitleInputArea):
        TitleInputArea.setWindowTitle(QCoreApplication.translate("TitleInputArea", u"Titel", None))
#if QT_CONFIG(accessibility)
        TitleInputArea.setAccessibleName(QCoreApplication.translate("TitleInputArea", u"TitleInputDialog", None))
#endif // QT_CONFIG(accessibility)
        TitleInputArea.setTitle(QCoreApplication.translate("TitleInputArea", u"Titel", None))
        self.headerLabel.setText(QCoreApplication.translate("TitleInputArea", u"Titel", None))
        self.fromLabel.setText(QCoreApplication.translate("TitleInputArea", u"ab", None))
        self.lastUpdateLabel.setText(QCoreApplication.translate("TitleInputArea", u"Letzte \u00c4nderung", None))
        self.titleLabel.setText(QCoreApplication.translate("TitleInputArea", u"Titel", None))
        self.addPushButton.setText(QCoreApplication.translate("TitleInputArea", u"+", None))
        self.editFinishPushButton.setText(QCoreApplication.translate("TitleInputArea", u"Bearbeiten", None))
    # retranslateUi
