...
class Ui_OSInputArea:
    ...
    def retranslateUi(self, OSInputArea):
        OSInputArea.setWindowTitle(
            QCoreApplication.translate("OSInputArea", "Betriebssystem", None)
        )
        ...
        self.nameLabel.setText(QCoreApplication.translate("OSInputArea", "Name", None))
        self.versionLabel.setText(
            QCoreApplication.translate("OSInputArea", "Version", None)
        )
        self.fixLabel.setText(QCoreApplication.translate("OSInputArea", "Fix", None))
        self.revisionLabel.setText(
            QCoreApplication.translate("OSInputArea", "Revision", None)
        )
        self.lastUpdateLabel.setText(
            QCoreApplication.translate("OSInputArea", "Letzte \u00c4nderung", None)
        )
        self.addPushButton.setText(QCoreApplication.translate("OSInputArea", "+", None))
        self.editFinishPushButton.setText(
            QCoreApplication.translate("OSInputArea", "Bearbeiten", None)
        )
