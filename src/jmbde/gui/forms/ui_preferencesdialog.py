...
class Ui_PreferencesDialog(object):
    def setupUi(self, PreferencesDialog):
        ...
        QWidget.setTabOrder(self.lineEditDatabaseConnection, self.pushButtonDBForceFileDialog)
    ...
    def retranslateUi(self, PreferencesDialog):
        ...
        PreferencesDialog.setAccessibleName(QCoreApplication.translate("PreferencesDialog", u"PreferencesDialog", None))
#endif // QT_CONFIG(accessibility)
        self.pushButtonDBForceFileDialog.setText(QCoreApplication.translate("PreferencesDialog", u"...", None))
        self.labelPassword.setText(QCoreApplication.translate("PreferencesDialog", u"Passwort", None))
        self.labelUserName.setText(QCoreApplication.translate("PreferencesDialog", u"Benutzername", None))
        self.labelDatabaseType.setText(QCoreApplication.translate("PreferencesDialog", u"Datenbank Typ", None))
        self.labelDatabaseConnection.setText(QCoreApplication.translate("PreferencesDialog", u"Datenbank Verbindung", None))
        self.labelHostName.setText(QCoreApplication.translate("PreferencesDialog", u"Hostname", None))
    # retranslateUi
