...
class Ui_ChipCardInputArea(object):
    ...
    def retranslateUi(self, ChipCardInputArea):
        ChipCardInputArea.setWindowTitle(QCoreApplication.translate("ChipCardInputArea", u"Chip Card", None))
#if QT_CONFIG(accessibility)
        ChipCardInputArea.setAccessibleName(QCoreApplication.translate("ChipCardInputArea", u"ChipCardInputDialog", None))
#endif // QT_CONFIG(accessibility)
        ChipCardInputArea.setTitle(QCoreApplication.translate("ChipCardInputArea", u"Chip Card", None))
        self.label_Header.setText(QCoreApplication.translate("ChipCardInputArea", u"ChipCard", None))
        self.label_Number.setText(QCoreApplication.translate("ChipCardInputArea", u"Number", None))
        self.label_Version.setText(QCoreApplication.translate("ChipCardInputArea", u"Door", None))
        self.label_Revision.setText(QCoreApplication.translate("ChipCardInputArea", u"Profile", None))
        self.label_Fix.setText(QCoreApplication.translate("ChipCardInputArea", u"Employee", None))
        self.pushButton_Add.setText(QCoreApplication.translate("ChipCardInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("ChipCardInputArea", u"Edit", None))
    # retranslateUi
