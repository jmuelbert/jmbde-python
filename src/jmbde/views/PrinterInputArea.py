...
class Ui_PrinterInputArea(object):
    ...
    def retranslateUi(self, PrinterInputArea):
        PrinterInputArea.setWindowTitle(QCoreApplication.translate("PrinterInputArea", u"Printer", None))
#if QT_CONFIG(accessibility)
        PrinterInputArea.setAccessibleName(QCoreApplication.translate("PrinterInputArea", u"PrinterInputDialog", None))
#endif // QT_CONFIG(accessibility)
        PrinterInputArea.setTitle(QCoreApplication.translate("PrinterInputArea", u"Printer", None))
        self.label_Header.setText(QCoreApplication.translate("PrinterInputArea", u"Printer", None))
        self.checkBox_Color.setText(QCoreApplication.translate("PrinterInputArea", u"Color", None))
        self.label_SerialNumber.setText(QCoreApplication.translate("PrinterInputArea", u"Serial Number", None))
        self.label_Place.setText(QCoreApplication.translate("PrinterInputArea", u"Place", None))
        self.label_Name.setText(QCoreApplication.translate("PrinterInputArea", u"Name", None))
        self.label_Devicename.setText(QCoreApplication.translate("PrinterInputArea", u"Devicename", None))
        self.label_Papersize.setText(QCoreApplication.translate("PrinterInputArea", u"Papersize", None))
        self.label_Department.setText(QCoreApplication.translate("PrinterInputArea", u"Department", None))
        self.label_Inventory.setText(QCoreApplication.translate("PrinterInputArea", u"Inventory", None))
        self.label_DeviceType.setText(QCoreApplication.translate("PrinterInputArea", u"Devicetype", None))
        self.label_Resources.setText(QCoreApplication.translate("PrinterInputArea", u"Resources", None))
        self.label_Employee.setText(QCoreApplication.translate("PrinterInputArea", u"Employee", None))
        self.checkBox_Active.setText(QCoreApplication.translate("PrinterInputArea", u"Active", None))
        self.label_Manufacturer.setText(QCoreApplication.translate("PrinterInputArea", u"Manufacturer", None))
        self.label_Network.setText(QCoreApplication.translate("PrinterInputArea", u"Network", None))
        self.label_IPAddress.setText(QCoreApplication.translate("PrinterInputArea", u"IP Address", None))
        self.checkBox_Replace.setText(QCoreApplication.translate("PrinterInputArea", u"Replace", None))
        self.label_Computer.setText(QCoreApplication.translate("PrinterInputArea", u"Computer", None))
        self.pushButton_Add.setText(QCoreApplication.translate("PrinterInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("PrinterInputArea", u"Edit", None))
    # retranslateUi
