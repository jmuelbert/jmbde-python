...
class Ui_SoftwareInputArea(object):
    ...
    def retranslateUi(self, SoftwareInputArea):
        ...
        self.label_Header.setText(QCoreApplication.translate("SoftwareInputArea", u"Software", None))
        self.label_Revision.setText(QCoreApplication.translate("SoftwareInputArea", u"Revision", None))
        self.label_Version.setText(QCoreApplication.translate("SoftwareInputArea", u"Version", None))
        self.label_Name.setText(QCoreApplication.translate("SoftwareInputArea", u"Name", None))
        self.label_Fix.setText(QCoreApplication.translate("SoftwareInputArea", u"Fix", None))
        self.pushButton_Add.setText(QCoreApplication.translate("SoftwareInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("SoftwareInputArea", u"Edit", None))
    # retranslateUi
