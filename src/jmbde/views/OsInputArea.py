...
class Ui_OSInputArea(object):
    ...
    def retranslateUi(self, OSInputArea):
        OSInputArea.setWindowTitle(QCoreApplication.translate("OSInputArea", u"Operation System", None))
#if QT_CONFIG(accessibility)
        OSInputArea.setAccessibleName(QCoreApplication.translate("OSInputArea", u"OSInputDialog", None))
#endif // QT_CONFIG(accessibility)
        OSInputArea.setTitle(QCoreApplication.translate("OSInputArea", u"Operation System", None))
        self.label_Header.setText(QCoreApplication.translate("OSInputArea", u"Operation System", None))
        self.label_Version.setText(QCoreApplication.translate("OSInputArea", u"Version", None))
        self.label_Revision.setText(QCoreApplication.translate("OSInputArea", u"Revision", None))
        self.label_Name.setText(QCoreApplication.translate("OSInputArea", u"Name", None))
        self.label_Fix.setText(QCoreApplication.translate("OSInputArea", u"Fix", None))
        self.pushButton_Add.setText(QCoreApplication.translate("OSInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("OSInputArea", u"Edit", None))
    # retranslateUi
