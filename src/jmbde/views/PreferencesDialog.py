...
class Ui_PreferencesDialog(object):
    ...
    def retranslateUi(self, PreferencesDialog):
        ...
        self.labelPassword.setText(QCoreApplication.translate("PreferencesDialog", u"Password", None))
        self.labelUserName.setText(QCoreApplication.translate("PreferencesDialog", u"Username", None))
        self.labelDatabaseType.setText(QCoreApplication.translate("PreferencesDialog", u"Database Type", None))
        self.labelDatabaseConnection.setText(QCoreApplication.translate("PreferencesDialog", u"Database Connc.", None))
