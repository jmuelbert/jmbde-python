...
class Ui_ManufacturerInputArea(object):
    ...
    def retranslateUi(self, ManufacturerInputArea):
        ManufacturerInputArea.setWindowTitle(QCoreApplication.translate("ManufacturerInputArea", u"Manufacturer", None))
        ...
        ManufacturerInputArea.setTitle(QCoreApplication.translate("ManufacturerInputArea", u"Manufacturer", None))
        self.label_Header.setText(QCoreApplication.translate("ManufacturerInputArea", u"Manufacturer", None))
        self.label_Phone.setText(QCoreApplication.translate("ManufacturerInputArea", u"Phone Number", None))
        self.label_MailAddress.setText(QCoreApplication.translate("ManufacturerInputArea", u"Mail Address", None))
        self.label_Name2.setText(QCoreApplication.translate("ManufacturerInputArea", u"Name2", None))
        self.label_ZipCode.setText(QCoreApplication.translate("ManufacturerInputArea", u"Zip Code", None))
        self.label_Fax.setText(QCoreApplication.translate("ManufacturerInputArea", u"Fax Number", None))
        self.label_Address2.setText(QCoreApplication.translate("ManufacturerInputArea", u"Address2", None))
        self.label_Address.setText(QCoreApplication.translate("ManufacturerInputArea", u"Address", None))
        self.label_Name.setText(QCoreApplication.translate("ManufacturerInputArea", u"Name", None))
        self.label_Supporter.setText(QCoreApplication.translate("ManufacturerInputArea", u"Supporter", None))
        self.label_Hotline.setText(QCoreApplication.translate("ManufacturerInputArea", u"Hotline Number", None))
        self.label_City.setText(QCoreApplication.translate("ManufacturerInputArea", u"City", None))
        self.pushButton_Add.setText(QCoreApplication.translate("ManufacturerInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("ManufacturerInputArea", u"Edit", None))
    # retranslateUi
