...
class Ui_EmployeeInputArea(object):
    def setupUi(self, EmployeeInputArea):
        ...
        self.comboBox_EmployeeDocument.setObjectName(u"comboBox_EmployeeDocument")
        ...
        self.comboBox_EmployeeAccount.setObjectName(u"comboBox_EmployeeAccount")
        ...
        QWidget.setTabOrder(self.comboBox_EmployeeAccount, self.comboBox_EmployeeDocument)
    ...
    def retranslateUi(self, EmployeeInputArea):
        EmployeeInputArea.setWindowTitle(QCoreApplication.translate("EmployeeInputArea", u"Employee", None))
#if QT_CONFIG(accessibility)
        EmployeeInputArea.setAccessibleName(QCoreApplication.translate("EmployeeInputArea", u"EmployeeInputDialog", None))
#endif // QT_CONFIG(accessibility)
        EmployeeInputArea.setTitle(QCoreApplication.translate("EmployeeInputArea", u"Employee", None))
        self.label_Header.setText(QCoreApplication.translate("EmployeeInputArea", u"Employee", None))
        self.label_EndDate.setText(QCoreApplication.translate("EmployeeInputArea", u"End Date", None))
        self.label_HomeMobile.setText(QCoreApplication.translate("EmployeeInputArea", u"Home Mobile", None))
        self.label_FirstName.setText(QCoreApplication.translate("EmployeeInputArea", u"Firstname", None))
        self.label_BusinessMail.setText(QCoreApplication.translate("EmployeeInputArea", u"Businessmail", None))
        self.label_LastName.setText(QCoreApplication.translate("EmployeeInputArea", u"Lastname", None))
        self.label_Address.setText(QCoreApplication.translate("EmployeeInputArea", u"Address", None))
        self.label_Computer.setText(QCoreApplication.translate("EmployeeInputArea", u"Computer", None))
        self.label_ZipCode.setText(QCoreApplication.translate("EmployeeInputArea", u"Zipcode", None))
        self.label_EmployeeAccount.setText(QCoreApplication.translate("EmployeeInputArea", u"Employee Account", None))
        self.label_Notes.setText(QCoreApplication.translate("EmployeeInputArea", u"Notes", None))
        self.checkBox_DataCare.setText(QCoreApplication.translate("EmployeeInputArea", u"Datacare", None))
        self.label_PersNumber.setText(QCoreApplication.translate("EmployeeInputArea", u"Pers.Number", None))
        self.label_HomePhone.setText(QCoreApplication.translate("EmployeeInputArea", u"Home Phone", None))
        self.label_Birthday.setText(QCoreApplication.translate("EmployeeInputArea", u"Birthday", None))
        self.label_Function.setText(QCoreApplication.translate("EmployeeInputArea", u"Function", None))
        self.label_Phone.setText(QCoreApplication.translate("EmployeeInputArea", u"Phone", None))
        self.label_Title.setText(QCoreApplication.translate("EmployeeInputArea", u"Titel", None))
        self.label_Lastupdate_Date.setText(QCoreApplication.translate("EmployeeInputArea", u"Date", None))
        self.label_Gender.setText(QCoreApplication.translate("EmployeeInputArea", u"Gender", None))
        self.label_Fax.setText(QCoreApplication.translate("EmployeeInputArea", u"Fax", None))
        self.label_ChipCard.setText(QCoreApplication.translate("EmployeeInputArea", u"ChipCard", None))
        self.label_Printer.setText(QCoreApplication.translate("EmployeeInputArea", u"Printer", None))
        self.checkBox_Active.setText(QCoreApplication.translate("EmployeeInputArea", u"Active", None))
        self.label_Mobile.setText(QCoreApplication.translate("EmployeeInputArea", u"Mobile", None))
        self.label_EmployeeDocument.setText(QCoreApplication.translate("EmployeeInputArea", u"Employee Document", None))
        self.label_StartDate.setText(QCoreApplication.translate("EmployeeInputArea", u"Start Date", None))
        self.label_Department.setText(QCoreApplication.translate("EmployeeInputArea", u"Department", None))
        self.label_Lastupdate.setText(QCoreApplication.translate("EmployeeInputArea", u"Last Update", None))
        self.label_HomeMail.setText(QCoreApplication.translate("EmployeeInputArea", u"Home Mail", None))
        self.label_City.setText(QCoreApplication.translate("EmployeeInputArea", u"City", None))
        self.pushButton_Add.setText(QCoreApplication.translate("EmployeeInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("EmployeeInputArea", u"Edit", None))
    # retranslateUi
