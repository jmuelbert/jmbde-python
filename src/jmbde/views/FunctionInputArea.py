...
class Ui_FunctionInputArea(object):
    ...
    def retranslateUi(self, FunctionInputArea):
        FunctionInputArea.setWindowTitle(QCoreApplication.translate("FunctionInputArea", u"Function", None))
#if QT_CONFIG(accessibility)
        FunctionInputArea.setAccessibleName(QCoreApplication.translate("FunctionInputArea", u"FunctionInputDialog", None))
#endif // QT_CONFIG(accessibility)
        FunctionInputArea.setTitle(QCoreApplication.translate("FunctionInputArea", u"Function", None))
        self.label_Header.setText(QCoreApplication.translate("FunctionInputArea", u"Function", None))
        self.label_Priority.setText(QCoreApplication.translate("FunctionInputArea", u"Priority", None))
        self.label_Name.setText(QCoreApplication.translate("FunctionInputArea", u"Name", None))
        self.pushButton_Add.setText(QCoreApplication.translate("FunctionInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("FunctionInputArea", u"Edit", None))
    # retranslateUi
