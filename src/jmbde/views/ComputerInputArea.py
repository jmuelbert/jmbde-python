...
class Ui_ComputerInputArea(object):
    ...
    def retranslateUi(self, ComputerInputArea):
        ...
        self.label_ServiceNumber.setText(QCoreApplication.translate("ComputerInputArea", u"Service Number", None))
        self.checkBox_Active.setText(QCoreApplication.translate("ComputerInputArea", u"Active", None))
        self.checkBox_Replace.setText(QCoreApplication.translate("ComputerInputArea", u"Replace", None))
        self.label_OperationSystem.setText(QCoreApplication.translate("ComputerInputArea", u"Operation System", None))
        self.label_Place.setText(QCoreApplication.translate("ComputerInputArea", u"Place", None))
        self.label_Employee.setText(QCoreApplication.translate("ComputerInputArea", u"Employee", None))
        self.label_Processor.setText(QCoreApplication.translate("ComputerInputArea", u"Processor", None))
        self.label_Inventory.setText(QCoreApplication.translate("ComputerInputArea", u"Inventory", None))
        self.label_Manufacturer.setText(QCoreApplication.translate("ComputerInputArea", u"Manufacturer", None))
        self.label_Name.setText(QCoreApplication.translate("ComputerInputArea", u"Name", None))
        self.label_IPAddress.setText(QCoreApplication.translate("ComputerInputArea", u"IP Address", None))
        self.label_SerialNumber.setText(QCoreApplication.translate("ComputerInputArea", u"Serial Number", None))
        self.label_Network.setText(QCoreApplication.translate("ComputerInputArea", u"Network", None))
        self.label_Devicename.setText(QCoreApplication.translate("ComputerInputArea", u"Devicename", None))
        self.label_DeviceType.setText(QCoreApplication.translate("ComputerInputArea", u"Devicetype", None))
        self.label_Department.setText(QCoreApplication.translate("ComputerInputArea", u"Department", None))
        self.label_ServiceTag.setText(QCoreApplication.translate("ComputerInputArea", u"Service Tag", None))
        self.label_Software.setText(QCoreApplication.translate("ComputerInputArea", u"Software", None))
        self.label_Printer.setText(QCoreApplication.translate("ComputerInputArea", u"Printer", None))
        self.pushButton_Add.setText(QCoreApplication.translate("ComputerInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("ComputerInputArea", u"Edit", None))
    # retranslateUi
