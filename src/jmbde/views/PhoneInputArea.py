...
class Ui_PhoneInputArea(object):
    def setupUi(self, PhoneInputArea):
        ...
        self.label_DeviceType.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)
        ...
        self.label_Employee.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)
        ...
        self.label_DeviceName.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)
    ...
    def retranslateUi(self, PhoneInputArea):
        PhoneInputArea.setWindowTitle(QCoreApplication.translate("PhoneInputArea", u"Phone", None))
#if QT_CONFIG(accessibility)
        PhoneInputArea.setAccessibleName(QCoreApplication.translate("PhoneInputArea", u"PhoneInputDialog", None))
#endif // QT_CONFIG(accessibility)
        PhoneInputArea.setTitle(QCoreApplication.translate("PhoneInputArea", u"Phone", None))
        self.label_Header.setText(QCoreApplication.translate("PhoneInputArea", u"Phone", None))
        self.label_Department.setText(QCoreApplication.translate("PhoneInputArea", u"Department", None))
        self.label_Number.setText(QCoreApplication.translate("PhoneInputArea", u"Number", None))
        self.label_Place.setText(QCoreApplication.translate("PhoneInputArea", u"Place", None))
        self.label_Manufacturer.setText(QCoreApplication.translate("PhoneInputArea", u"Manufacturer", None))
        self.label_DeviceType.setText(QCoreApplication.translate("PhoneInputArea", u"Devicetype", None))
        self.label_Employee.setText(QCoreApplication.translate("PhoneInputArea", u"Employee", None))
        self.checkBox_Replace.setText(QCoreApplication.translate("PhoneInputArea", u"Replace", None))
        self.label_Pin.setText(QCoreApplication.translate("PhoneInputArea", u"Pin", None))
        self.label_DeviceName.setText(QCoreApplication.translate("PhoneInputArea", u"Devicename", None))
        self.checkBox_Active.setText(QCoreApplication.translate("PhoneInputArea", u"Active", None))
        self.label_Inventory.setText(QCoreApplication.translate("PhoneInputArea", u"Inventory", None))
        self.label_SerialNumber.setText(QCoreApplication.translate("PhoneInputArea", u"Serial Number", None))
        self.pushButton_Add.setText(QCoreApplication.translate("PhoneInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("PhoneInputArea", u"Edit", None))
    # retranslateUi
