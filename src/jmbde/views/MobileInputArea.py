...
class Ui_MobileInputArea(object):
    ...
    def retranslateUi(self, MobileInputArea):
        MobileInputArea.setWindowTitle(QCoreApplication.translate("MobileInputArea", u"Mobile", None))
#if QT_CONFIG(accessibility)
        MobileInputArea.setAccessibleName(QCoreApplication.translate("MobileInputArea", u"MobileInputDialog", None))
#endif // QT_CONFIG(accessibility)
        MobileInputArea.setTitle(QCoreApplication.translate("MobileInputArea", u"Mobile", None))
        self.label_Header.setText(QCoreApplication.translate("MobileInputArea", u"Mobile", None))
        self.label_DeviceName.setText(QCoreApplication.translate("MobileInputArea", u"Devicename", None))
        self.label_Department.setText(QCoreApplication.translate("MobileInputArea", u"Department", None))
        self.label_Inventory.setText(QCoreApplication.translate("MobileInputArea", u"Inventory", None))
        self.label_Employee.setText(QCoreApplication.translate("MobileInputArea", u"Employee", None))
        self.label_Manufacturer.setText(QCoreApplication.translate("MobileInputArea", u"Manufacturer", None))
        self.checkBox_Replace.setText(QCoreApplication.translate("MobileInputArea", u"Replace", None))
        self.label_Place.setText(QCoreApplication.translate("MobileInputArea", u"Place", None))
        self.label_CardNumber.setText(QCoreApplication.translate("MobileInputArea", u"Card Number", None))
        self.label_Pin.setText(QCoreApplication.translate("MobileInputArea", u"Pin", None))
        self.label_DeviceType.setText(QCoreApplication.translate("MobileInputArea", u"Devicetype", None))
        self.checkBox_Active.setText(QCoreApplication.translate("MobileInputArea", u"Active", None))
        self.label_SerialNumber.setText(QCoreApplication.translate("MobileInputArea", u"Serial Number", None))
        self.label_Number.setText(QCoreApplication.translate("MobileInputArea", u"Number", None))
        self.pushButton_Add.setText(QCoreApplication.translate("MobileInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("MobileInputArea", u"Edit", None))
    # retranslateUi
