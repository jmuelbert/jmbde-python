...
class Ui_DepartmentInputArea(object):
    ...
    def retranslateUi(self, DepartmentInputArea):
        DepartmentInputArea.setWindowTitle(QCoreApplication.translate("DepartmentInputArea", u"Department", None))
        ...
        DepartmentInputArea.setTitle(QCoreApplication.translate("DepartmentInputArea", u"Department", None))
        self.label_Header.setText(QCoreApplication.translate("DepartmentInputArea", u"Department", None))
        self.label_Printer.setText(QCoreApplication.translate("DepartmentInputArea", u"Printer", None))
        self.label_Pri_Test.setText(QCoreApplication.translate("DepartmentInputArea", u"Pri-Test", None))
        self.label_Priority.setText(QCoreApplication.translate("DepartmentInputArea", u"Priority", None))
        self.label_Name.setText(QCoreApplication.translate("DepartmentInputArea", u"Name", None))
        self.label_Fax.setText(QCoreApplication.translate("DepartmentInputArea", u"Fax", None))
        self.pushButton_Add.setText(QCoreApplication.translate("DepartmentInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("DepartmentInputArea", u"Edit", None))
    # retranslateUi
