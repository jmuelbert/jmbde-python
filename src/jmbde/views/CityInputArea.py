...
class Ui_CityInputArea(object):
    ...
    def retranslateUi(self, CityInputArea):
        CityInputArea.setWindowTitle(QCoreApplication.translate("CityInputArea", u"City", None))
#if QT_CONFIG(accessibility)
        CityInputArea.setAccessibleName(QCoreApplication.translate("CityInputArea", u"CityInputDialog", None))
#endif // QT_CONFIG(accessibility)
        CityInputArea.setTitle(QCoreApplication.translate("CityInputArea", u"City", None))
        self.label_Header.setText(QCoreApplication.translate("CityInputArea", u"City", None))
        self.label_ZipCode.setText(QCoreApplication.translate("CityInputArea", u"Zip Code", None))
        self.label_CityName.setText(QCoreApplication.translate("CityInputArea", u"City Name", None))
        self.pushButton_Add.setText(QCoreApplication.translate("CityInputArea", u"+", None))
        self.pushButton_EditFinish.setText(QCoreApplication.translate("CityInputArea", u"Edit", None))
    # retranslateUi
